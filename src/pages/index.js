...
import HeroSection from '../components/HeroSection/heroSectionITDO.js';
    ...
    <div>
      ...
      <div className="main">
        <HeroSection
          ...
          description="Somos una empresa de desarrollo, expertos en creación de páginas web y APPs. Te ayudamos a crear tu página web con <strong><a href='/desarrollo-web'>la mejor relación calidad-precio</a></strong>, creando una <strong><a href='/desarrollo-web'>experiencia digital atractiva para que tu negocio conecte con las personas</a>.</strong>"
