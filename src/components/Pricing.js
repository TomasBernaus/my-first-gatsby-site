...
class Pricing extends React.Component {
  render() {
    return (
      <React.Fragment>
        <section
          id="precios-desarrollo"
          className={"package-section ptb-100 " + (this.props.bgColor && this.props.bgColor === "white" ? "" : "gray-light-bg")}
        >
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-8">
                <div className="section-heading text-center mb-5">
                  ...
                  <p className="lead">
                    Elige el plan de desarrollo de páginas web adecuado a tus necesidades o pide tu presupuesto personalizado. Te lo enviamos en un máximo de 24h.
                  </p>
                </div>
              </div>
            </div>
            <div className="row justify-content-center">
                ...
                <div className="card text-center single-pricing-pack ">
                  <div className="card-header py-5 border-0 pricing-header pb-20 ">
                    ...
                    <div className="h6 text-muted mt-10">
                      <a href="/contratar-desarrollo-web/Básico" className=" mb-3 ">Contratar</a>
                    </div>
                  </div>
                  <div className="card-body">
                    ...
                    <a href="/contratar-desarrollo-web/Básico" className="btn mb-3 primary-solid-btn">
                      Contratar
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6 pr-0 mt-10" key="1">
                <div className="card text-center single-pricing-pack ">
                  <div className="card-header py-5 border-0 pricing-header pb-20 ">
                    ...
                    <div className="h6 text-muted mt-10">
                      <a href="/contratar-desarrollo-web/Avanzado" className=" mb-3 ">Contratar</a>
                    </div>
                  </div>
                  <div className="card-body">
                    <ul className="list-unstyled text-sm mb-4 pricing-feature-list ">
                    ...
                    <a href="/contratar-desarrollo-web/Avanzado" className="btn mb-3 primary-solid-btn">
                      Contratar
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6 pr-0 mt-10" key="2">
                <div className="card text-center single-pricing-pack ">
                  <div className="card-header py-5 border-0 pricing-header pb-20 ">
                    <div className="h1 text-center mb-0">
                    ...
                    <div className="h6 text-muted mt-10">
                      <a href="/contratar-desarrollo-web/Profesional" className=" mb-3 ">Contratar</a>
                    </div>
                  </div>
                  <div className="card-body">
                    <ul className="list-unstyled text-sm mb-4 pricing-feature-list ">
                    ...
                    <a href="/contratar-desarrollo-web/Profesional" className="btn mb-3 primary-solid-btn">
                      Contratar
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6 pr-0 mt-10">
                <div className="card text-center single-pricing-pack primary-bg ">
                  <div className="card-header py-5 border-0 pricing-header pb-20 text-white">
                    ...
                    <div className="h6 text-muted mt-10">
                      <a href="/pedir-presupuesto/desarrollo-web" className=" mb-3 text-action">Pedir presupuesto</a>
                    </div>
                  </div>
                  <div className="card-body">
                    ...
                    <a href="/pedir-presupuesto/desarrollo-web" className="btn mb-3 solid-btn">
                      PEDIR PRESUPUESTO
                    </a>
                  </div>
                </div>
