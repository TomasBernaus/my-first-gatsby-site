...
const HeroSectionQuoteContact = ({ backgroundImage = 'https://ik.imagekit.io/itdo/ITDO-freelance6_xH56McWwC.jpg', description, title, service }) => {
          ...
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-7">
              <div className="page-header-content text-white text-center pt-5">
                ...
                <h1 className="text-white mb-1">{service ? service : hero.service}</h1>
