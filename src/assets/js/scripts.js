...
*/
   ...
   $(window).scroll(function() {
	   var hT = $('#precios-desarrollo-web').offset().top,
	       hH = $('#precios-desarrollo-web').outerHeight(),
	       wH = $(window).height(),
	       wS = $(this).scrollTop();
	   if (wS > (hT+hH-wH)){
		   if(loaded == false) {
			   loaded = true;
			   $('#lazy-loading-content').load('lc.html');
		   }
	   }
	});
...
if(document.getElementsByClassName("owl-dot")) {
	Array.from(document.getElementsByClassName("owl-dot")).forEach(
	    function(element, index, array) {
	        document.getElementsByClassName("owl-dot")[index].setAttribute("name", "owl-dot-"+index);
	    }
	);
}
